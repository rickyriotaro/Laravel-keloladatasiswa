<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold">Daftar Ekskul</h1>
        ...
        <!-- Filter -->
        <form method="GET" action="{{ route('ekskul.index') }}" class="mb-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <!-- Filter Nama Kelas -->
            <div>
                    ...
                    @foreach ($ekskul as $e)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-center flex justify-center items-center space-x-2">
                                ...
                                <!-- Tombol Hapus -->
                                <form action="{{ route('ekskul.destroy', $e->id) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
